...
files = dir("C:\Users\Matthew\Desktop\YNET2\UPDATE\simulation\test\sensor_data\*.png");
count = 10;
for file = files'
    file_path = strcat("C:\Users\Matthew\Desktop\YNET2\UPDATE\simulation\test\sensor_data\",file.name);
    im_ = imread(file_path);
    resized_img = imresize(im_, [128,128]);
    ...
    final_path = strcat("C:\Users\Matthew\Desktop\YNET2\UPDATE\simulation\test\time_reversal\","recon",int2str(count),".png");
    imwrite(imresize(p0_recon, [128,128]), final_path);
