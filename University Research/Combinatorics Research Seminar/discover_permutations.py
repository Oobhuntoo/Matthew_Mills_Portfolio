...
# This calculates the number of inversions in a given exceedence
...
# This plots the grid diagram of the permutation and portrays whether or not it is shallow
...
# This function performs the necessary calculations to show whether or not a permutation is shallow
