...
* COMPOUND
 ...
 66:     ST  3,-18(1)	Save left side 
 67:    LDC  3,5(6)	Load integer constant 
 68:     LD  4,-18(1)	Load left into ac1 
 69:    MUL  3,4,3	Op * 
 70:     ST  3,-18(1)	Save left side 
 71:    LDC  3,3(6)	Load integer constant 
 72:     ST  3,-19(1)	Save left side 
 73:    LDC  3,2(6)	Load integer constant 
 74:     LD  4,-19(1)	Load left into ac1 
 75:    MUL  3,4,3	Op * 
 76:     LD  4,-18(1)	Load left into ac1 
 77:    ADD  3,4,3	Op + 
...
* EXPRESSION
* CALL output
 83:     ST  1,-20(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
 90:     ST  1,-20(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL outputb
 95:     ST  1,-20(1)	Store fp in ghost frame for outputb
* PARAM 1
...
* EXPRESSION
* CALL outnl
102:     ST  1,-20(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL output
107:     ST  1,-20(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
115:     ST  1,-20(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL output
120:     ST  1,-20(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
127:     ST  1,-20(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL outputc
132:     ST  1,-20(1)	Store fp in ghost frame for outputc
* PARAM 1
...
* EXPRESSION
* CALL outnl
139:     ST  1,-20(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL outputb
144:     ST  1,-20(1)	Store fp in ghost frame for outputb
* PARAM 1
...
* EXPRESSION
* CALL outnl
151:     ST  1,-20(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL outputb
156:     ST  1,-20(1)	Store fp in ghost frame for outputb
* PARAM 1
...
* EXPRESSION
* CALL outnl
163:     ST  1,-20(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL outputb
168:     ST  1,-20(1)	Store fp in ghost frame for outputb
* PARAM 1
...
* EXPRESSION
* CALL outnl
175:     ST  1,-20(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL output
180:     ST  1,-20(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
188:     ST  1,-20(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL output
193:     ST  1,-20(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
200:     ST  1,-20(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL output
205:     ST  1,-20(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
212:     ST  1,-20(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL output
217:     ST  1,-20(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
224:     ST  1,-20(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL output
229:     ST  1,-20(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
237:     ST  1,-20(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL output
248:     ST  1,-42(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
256:     ST  1,-42(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL outputb
261:     ST  1,-42(1)	Store fp in ghost frame for outputb
* PARAM 1
...
* EXPRESSION
* CALL outnl
268:     ST  1,-42(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
287:     ST  3,-16(0)	Store variable sia
288:    LDC  3,15(6)	load size of array sib
289:     ST  3,-17(0)	save size of array sib
