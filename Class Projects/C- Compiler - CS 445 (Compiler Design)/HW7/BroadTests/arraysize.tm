...
* EXPRESSION
* CALL output
 59:     ST  1,-18(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
 71:     ST  1,-18(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
 79:     ST  1,-18(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
 91:     ST  1,-18(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
105:     ST  1,-18(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL output
110:     ST  1,-18(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
122:     ST  1,-18(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
130:     ST  1,-18(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL output
149:     ST  1,-14(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
161:     ST  1,-14(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
169:     ST  1,-14(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
181:     ST  1,-14(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
189:     ST  1,-14(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL ford
194:     ST  1,-14(1)	Store fp in ghost frame for ford
* PARAM 1
...
* EXPRESSION
* CALL ford
201:     ST  1,-14(1)	Store fp in ghost frame for ford
* PARAM 1
...
* EXPRESSION
* CALL output
208:     ST  1,-14(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
221:     ST  1,-14(1)	Store fp in ghost frame for outnl
* END PARAM outnl
