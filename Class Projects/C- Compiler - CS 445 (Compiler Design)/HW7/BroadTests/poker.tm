...
* RETURN
* CALL pips
 73:     ST  1,-4(1)	Store fp in ghost frame for pips
* PARAM 1
...
* CALL pips
 81:     ST  1,-5(1)	Store fp in ghost frame for pips
* PARAM 1
...
* RETURN
* CALL p
 99:     ST  1,-5(1)	Store fp in ghost frame for p
* PARAM 1
...
* CALL p
109:     ST  1,-6(1)	Store fp in ghost frame for p
* PARAM 1
...
* RETURN
* CALL p
129:     ST  1,-6(1)	Store fp in ghost frame for p
* PARAM 1
...
* CALL p
139:     ST  1,-7(1)	Store fp in ghost frame for p
* PARAM 1
...
* CALL p
151:     ST  1,-7(1)	Store fp in ghost frame for p
* PARAM 1
...
* EXPRESSION
* CALL suit
171:     ST  1,-9(1)	Store fp in ghost frame for suit
* PARAM 1
172:     LD  3,-2(1)	Load variable a
173:     ST  3,-11(1)	Store parameter 
* END PARAM suit
174:    LDA  1,-9(1)	Load address of new frame 
175:    LDA  3,1(7)	Return address in ac 
176:    LDA  7,-135(7)	CALL suit
177:    LDA  3,0(2)	Save the result in ac 
* END CALL suit
178:     ST  3,-9(1)	Save left side 
* CALL suit
179:     ST  1,-10(1)	Store fp in ghost frame for suit
* PARAM 1
...
* CALL suit
189:     ST  1,-10(1)	Store fp in ghost frame for suit
* PARAM 1
190:     LD  3,-2(1)	Load variable a
191:     ST  3,-12(1)	Store parameter 
* END PARAM suit
192:    LDA  1,-10(1)	Load address of new frame 
193:    LDA  3,1(7)	Return address in ac 
194:    LDA  7,-153(7)	CALL suit
195:    LDA  3,0(2)	Save the result in ac 
* END CALL suit
196:     ST  3,-10(1)	Save left side 
* CALL suit
197:     ST  1,-11(1)	Store fp in ghost frame for suit
* PARAM 1
198:     LD  3,-4(1)	Load variable c
199:     ST  3,-13(1)	Store parameter 
* END PARAM suit
200:    LDA  1,-11(1)	Load address of new frame 
...
208:     ST  3,-9(1)	Save left side 
* CALL suit
209:     ST  1,-10(1)	Store fp in ghost frame for suit
* PARAM 1
210:     LD  3,-2(1)	Load variable a
211:     ST  3,-12(1)	Store parameter 
* END PARAM suit
212:    LDA  1,-10(1)	Load address of new frame 
213:    LDA  3,1(7)	Return address in ac 
214:    LDA  7,-173(7)	CALL suit
215:    LDA  3,0(2)	Save the result in ac 
* END CALL suit
216:     ST  3,-10(1)	Save left side 
* CALL suit
217:     ST  1,-11(1)	Store fp in ghost frame for suit
* PARAM 1
218:     LD  3,-5(1)	Load variable d
219:     ST  3,-13(1)	Store parameter 
* END PARAM suit
220:    LDA  1,-11(1)	Load address of new frame 
221:    LDA  3,1(7)	Return address in ac 
222:    LDA  7,-181(7)	CALL suit
223:    LDA  3,0(2)	Save the result in ac 
* END CALL suit
224:     LD  4,-10(1)	Load left into ac1 
225:    TEQ  3,4,3	Op == 
226:     LD  4,-9(1)	Load left into ac1 
227:    AND  3,4,3	Op AND 
228:     ST  3,-9(1)	Save left side 
* CALL suit
229:     ST  1,-10(1)	Store fp in ghost frame for suit
* PARAM 1
230:     LD  3,-2(1)	Load variable a
231:     ST  3,-12(1)	Store parameter 
* END PARAM suit
232:    LDA  1,-10(1)	Load address of new frame 
233:    LDA  3,1(7)	Return address in ac 
234:    LDA  7,-193(7)	CALL suit
235:    LDA  3,0(2)	Save the result in ac 
* END CALL suit
236:     ST  3,-10(1)	Save left side 
* CALL suit
237:     ST  1,-11(1)	Store fp in ghost frame for suit
* PARAM 1
238:     LD  3,-6(1)	Load variable e
239:     ST  3,-13(1)	Store parameter 
* END PARAM suit
240:    LDA  1,-11(1)	Load address of new frame 
241:    LDA  3,1(7)	Return address in ac 
242:    LDA  7,-201(7)	CALL suit
243:    LDA  3,0(2)	Save the result in ac 
* END CALL suit
244:     LD  4,-10(1)	Load left into ac1 
245:    TEQ  3,4,3	Op == 
...
* CALL pips
251:     ST  1,-9(1)	Store fp in ghost frame for pips
* PARAM 1
...
* CALL pips
265:     ST  1,-9(1)	Store fp in ghost frame for pips
* PARAM 1
...
* CALL pips
283:     ST  1,-9(1)	Store fp in ghost frame for pips
* PARAM 1
...
* CALL pips
309:     ST  1,-9(1)	Store fp in ghost frame for pips
* PARAM 1
...
* CALL pips
317:     ST  1,-10(1)	Store fp in ghost frame for pips
* PARAM 1
...
* IF
* CALL pppp
339:     ST  1,-8(1)	Store fp in ghost frame for pppp
* PARAM 1
...
* CALL pppp
353:     ST  1,-9(1)	Store fp in ghost frame for pppp
* PARAM 1
...
* IF
* CALL ppp
375:     ST  1,-8(1)	Store fp in ghost frame for ppp
* PARAM 1
...
* CALL p
387:     ST  1,-9(1)	Store fp in ghost frame for p
* PARAM 1
...
* CALL p
399:     ST  1,-9(1)	Store fp in ghost frame for p
* PARAM 1
...
* CALL ppp
409:     ST  1,-10(1)	Store fp in ghost frame for ppp
* PARAM 1
...
* IF
* CALL pips
439:     ST  1,-8(1)	Store fp in ghost frame for pips
* PARAM 1
...
* CALL pips
447:     ST  1,-9(1)	Store fp in ghost frame for pips
* PARAM 1
...
* CALL pips
461:     ST  1,-9(1)	Store fp in ghost frame for pips
* PARAM 1
...
* CALL pips
469:     ST  1,-10(1)	Store fp in ghost frame for pips
* PARAM 1
...
* CALL pips
485:     ST  1,-9(1)	Store fp in ghost frame for pips
* PARAM 1
...
* CALL pips
493:     ST  1,-10(1)	Store fp in ghost frame for pips
* PARAM 1
...
* CALL pips
509:     ST  1,-9(1)	Store fp in ghost frame for pips
* PARAM 1
...
* CALL pips
517:     ST  1,-10(1)	Store fp in ghost frame for pips
* PARAM 1
...
* CALL pips
533:     ST  1,-9(1)	Store fp in ghost frame for pips
* PARAM 1
...
* CALL pips
545:     ST  1,-10(1)	Store fp in ghost frame for pips
* PARAM 1
...
* CALL pips
563:     ST  1,-10(1)	Store fp in ghost frame for pips
* PARAM 1
...
* CALL pips
581:     ST  1,-10(1)	Store fp in ghost frame for pips
* PARAM 1
...
* CALL pips
599:     ST  1,-10(1)	Store fp in ghost frame for pips
* PARAM 1
...
* IF
* CALL ppp
625:     ST  1,-8(1)	Store fp in ghost frame for ppp
* PARAM 1
...
* CALL ppp
637:     ST  1,-9(1)	Store fp in ghost frame for ppp
* PARAM 1
...
* CALL ppp
651:     ST  1,-9(1)	Store fp in ghost frame for ppp
* PARAM 1
...
* IF
* CALL p
671:     ST  1,-8(1)	Store fp in ghost frame for p
* PARAM 1
...
* CALL p
681:     ST  1,-9(1)	Store fp in ghost frame for p
* PARAM 1
...
* CALL p
693:     ST  1,-9(1)	Store fp in ghost frame for p
* PARAM 1
...
* CALL p
703:     ST  1,-10(1)	Store fp in ghost frame for p
* PARAM 1
...
* CALL p
717:     ST  1,-9(1)	Store fp in ghost frame for p
* PARAM 1
...
* CALL p
727:     ST  1,-10(1)	Store fp in ghost frame for p
* PARAM 1
...
* IF
* CALL p
747:     ST  1,-8(1)	Store fp in ghost frame for p
* PARAM 1
...
* CALL p
757:     ST  1,-9(1)	Store fp in ghost frame for p
* PARAM 1
...
* CALL p
769:     ST  1,-9(1)	Store fp in ghost frame for p
* PARAM 1
...
* CALL p
781:     ST  1,-9(1)	Store fp in ghost frame for p
* PARAM 1
...
828:     ST  3,-22(1)	Save left side 
829:    LDC  3,1(6)	Load integer constant 
830:     LD  4,-22(1)	Load left into ac1 
831:    ADD  3,4,3	Op + 
...
839:     ST  3,-22(1)	Save left side 
840:     LD  3,0(0)	Load variable numSuits
841:     LD  4,-22(1)	Load left into ac1 
842:    MUL  3,4,3	Op * 
843:     ST  3,-22(1)	Save left side 
844:    LDC  3,1(6)	Load integer constant 
845:     LD  4,-22(1)	Load left into ac1 
846:    SUB  3,4,3	Op - 
...
* EXPRESSION
* CALL output
859:     ST  1,-21(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
866:     ST  1,-21(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
872:     ST  3,-22(1)	Save left side 
873:    LDC  3,1(6)	Load integer constant 
874:     LD  4,-22(1)	Load left into ac1 
875:    ADD  3,4,3	Op + 
...
885:     ST  3,-22(1)	Save left side 
886:    LDC  3,1(6)	Load integer constant 
887:     LD  4,-22(1)	Load left into ac1 
888:    ADD  3,4,3	Op + 
...
898:     ST  3,-22(1)	Save left side 
899:    LDC  3,1(6)	Load integer constant 
900:     LD  4,-22(1)	Load left into ac1 
901:    ADD  3,4,3	Op + 
...
911:     ST  3,-22(1)	Save left side 
912:    LDC  3,1(6)	Load integer constant 
913:     LD  4,-22(1)	Load left into ac1 
914:    ADD  3,4,3	Op + 
...
924:     ST  3,-22(1)	Save left side 
925:    LDC  3,1(6)	Load integer constant 
926:     LD  4,-22(1)	Load left into ac1 
927:    ADD  3,4,3	Op + 
928:     ST  3,-19(1)	Store variable possible
* EXPRESSION
* CALL handtype
929:     ST  1,-22(1)	Store fp in ghost frame for handtype
* PARAM 1
930:     LD  3,-13(1)	Load variable a
931:     ST  3,-24(1)	Store parameter 
* PARAM 2
932:     LD  3,-14(1)	Load variable b
933:     ST  3,-25(1)	Store parameter 
* PARAM 3
934:     LD  3,-15(1)	Load variable c
935:     ST  3,-26(1)	Store parameter 
* PARAM 4
936:     LD  3,-16(1)	Load variable d
937:     ST  3,-27(1)	Store parameter 
* PARAM 5
938:     LD  3,-17(1)	Load variable e
939:     ST  3,-28(1)	Store parameter 
* END PARAM handtype
940:    LDA  1,-22(1)	Load address of new frame 
...
947:    LDA  3,-3(1)	Load address of base of array hands
948:     ST  3,-22(1)	Save left side 
949:     LD  3,-18(1)	Load variable h
950:     LD  4,-22(1)	Load left into ac1 
951:    SUB  3,4,3	compute location from index 
952:     LD  3,0(3)	Load array element 
953:     ST  3,-22(1)	Save left side 
954:    LDC  3,1(6)	Load integer constant 
955:     LD  4,-22(1)	Load left into ac1 
956:    ADD  3,4,3	Op + 
957:     LD  4,-21(1)	Restore index 
958:    LDA  5,-3(1)	Load address of base of array hands
959:    SUB  5,5,4	Compute offset of value 
960:     ST  3,0(5)	Store variable hands
* EXPRESSION
961:     LD  3,-17(1)	load lhs variable e
962:    LDA  3,1(3)	increment value of e
963:     ST  3,-17(1)	Store variable e
* END COMPOUND
964:    LDA  7,-49(7)	go to beginning of loop 
922:    LDA  7,42(7)	Jump past loop [backpatch] 
* END WHILE
* EXPRESSION
965:     LD  3,-16(1)	load lhs variable d
966:    LDA  3,1(3)	increment value of d
967:     ST  3,-16(1)	Store variable d
* END COMPOUND
968:    LDA  7,-66(7)	go to beginning of loop 
909:    LDA  7,59(7)	Jump past loop [backpatch] 
* END WHILE
* EXPRESSION
969:     LD  3,-15(1)	load lhs variable c
970:    LDA  3,1(3)	increment value of c
971:     ST  3,-15(1)	Store variable c
* END COMPOUND
972:    LDA  7,-83(7)	go to beginning of loop 
896:    LDA  7,76(7)	Jump past loop [backpatch] 
* END WHILE
* EXPRESSION
973:     LD  3,-14(1)	load lhs variable b
974:    LDA  3,1(3)	increment value of b
975:     ST  3,-14(1)	Store variable b
* END COMPOUND
976:    LDA  7,-100(7)	go to beginning of loop 
883:    LDA  7,93(7)	Jump past loop [backpatch] 
* END WHILE
* EXPRESSION
977:     LD  3,-13(1)	load lhs variable a
978:    LDA  3,1(3)	increment value of a
979:     ST  3,-13(1)	Store variable a
* END COMPOUND
980:    LDA  7,-129(7)	go to beginning of loop 
858:    LDA  7,122(7)	Jump past loop [backpatch] 
* END WHILE
* EXPRESSION
981:    LDC  3,0(6)	Load integer constant 
982:     ST  3,-18(1)	Store variable h
* WHILE
983:     LD  3,-18(1)	Load variable h
984:     ST  3,-21(1)	Save left side 
985:    LDC  3,10(6)	Load integer constant 
986:     LD  4,-21(1)	Load left into ac1 
987:    TLT  3,4,3	Op < 
988:    JNZ  3,1(7)	Jump to while part 
* DO
* COMPOUND
* Compound Body
* EXPRESSION
* CALL output
990:     ST  1,-21(1)	Store fp in ghost frame for output
* PARAM 1
991:     LD  3,-18(1)	Load variable h
992:     ST  3,-23(1)	Store parameter 
* END PARAM output
993:    LDA  1,-21(1)	Load address of new frame 
...
* EXPRESSION
* CALL output
997:     ST  1,-21(1)	Store fp in ghost frame for output
* PARAM 1
998:    LDA  3,-3(1)	Load address of base of array hands
999:     ST  3,-23(1)	Save left side 
1000:     LD  3,-18(1)	Load variable h
1001:     LD  4,-23(1)	Load left into ac1 
1002:    SUB  3,4,3	compute location from index 
1003:     LD  3,0(3)	Load array element 
1004:     ST  3,-23(1)	Store parameter 
* END PARAM output
1005:    LDA  1,-21(1)	Load address of new frame 
...
* EXPRESSION
* CALL outnl
1009:     ST  1,-21(1)	Store fp in ghost frame for outnl
* END PARAM outnl
1010:    LDA  1,-21(1)	Load address of new frame 
1011:    LDA  3,1(7)	Return address in ac 
1012:    LDA  7,-976(7)	CALL outnl
1013:    LDA  3,0(2)	Save the result in ac 
* END CALL outnl
* EXPRESSION
1014:     LD  3,-18(1)	Load variable h
1015:     ST  3,-22(1)	Save left side 
1016:    LDC  3,1(6)	Load integer constant 
1017:     LD  4,-22(1)	Load left into ac1 
1018:    ADD  3,4,3	Op + 
1019:     ST  3,-18(1)	Store variable h
* END COMPOUND
1020:    LDA  7,-38(7)	go to beginning of loop 
989:    LDA  7,31(7)	Jump past loop [backpatch] 
* END WHILE
* RETURN
1021:    LDC  3,0(6)	Load integer constant 
1022:    LDA  2,0(3)	Copy result to rt register 
1023:     LD  3,-1(1)	Load return address 
1024:     LD  1,0(1)	Adjust fp 
1025:    LDA  7,0(3)	Return 
* END COMPOUND
* Add standard closing in case there is no return statement
1026:    LDC  2,0(6)	Set return value to 0 
1027:     LD  3,-1(1)	Load return address 
1028:     LD  1,0(1)	Adjust fp 
1029:    LDA  7,0(3)	Return 
* END FUNCTION main
  0:    LDA  7,1029(7)	Jump to init [backpatch] 
* INIT
1030:     LD  0,0(0)	Set the global pointer 
1031:    LDA  1,-3(0)	set first frame at end of globals 
1032:     ST  1,0(1)	store old fp (point to self) 
* INIT GLOBALS AND STATICS
* END INIT GLOBALS AND STATICS
1033:    LDA  3,1(7)	Return address in ac 
1034:    LDA  7,-227(7)	Jump to main 
1035:   HALT  0,0,0	DONE! 
* END INIT
