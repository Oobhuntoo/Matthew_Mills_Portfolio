...
* EXPRESSION
* CALL output
 58:     ST  1,-32(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
 77:     ST  1,-32(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outputb
 96:     ST  1,-32(1)	Store fp in ghost frame for outputb
* PARAM 1
...
* EXPRESSION
* CALL outputb
115:     ST  1,-32(1)	Store fp in ghost frame for outputb
* PARAM 1
...
* EXPRESSION
* CALL outnl
127:     ST  1,-32(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL output
139:     ST  1,-32(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
158:     ST  1,-32(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outputb
177:     ST  1,-32(1)	Store fp in ghost frame for outputb
* PARAM 1
...
* EXPRESSION
* CALL outputb
196:     ST  1,-32(1)	Store fp in ghost frame for outputb
* PARAM 1
...
* EXPRESSION
* CALL outnl
208:     ST  1,-32(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL output
225:     ST  1,-32(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outputb
249:     ST  1,-32(1)	Store fp in ghost frame for outputb
* PARAM 1
...
* EXPRESSION
* CALL outnl
261:     ST  1,-32(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL output
278:     ST  1,-32(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outputb
302:     ST  1,-32(1)	Store fp in ghost frame for outputb
* PARAM 1
...
* EXPRESSION
* CALL outnl
314:     ST  1,-32(1)	Store fp in ghost frame for outnl
* END PARAM outnl
