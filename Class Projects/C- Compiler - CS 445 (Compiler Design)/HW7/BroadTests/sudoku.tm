...
121:     LD  4,-6(1)	Load left into ac1 
122:    MUL  3,4,3	Op * 
...
* IF
* CALL getValue
170:     ST  1,-9(1)	Store fp in ghost frame for getValue
* PARAM 1
...
* IF
* CALL getValue
189:     ST  1,-9(1)	Store fp in ghost frame for getValue
* PARAM 1
...
213:     ST  3,-10(1)	Save left side 
214:    LDC  3,3(6)	Load integer constant 
215:     LD  4,-10(1)	Load left into ac1 
216:    DIV  3,4,3	Op / 
217:     ST  3,-10(1)	Save left side 
218:    LDC  3,3(6)	Load integer constant 
219:     LD  4,-10(1)	Load left into ac1 
220:    MUL  3,4,3	Op * 
221:     ST  3,-7(1)	Store variable boxRowStart
* EXPRESSION
222:     LD  3,-3(1)	Load variable col
223:     ST  3,-10(1)	Save left side 
224:    LDC  3,3(6)	Load integer constant 
225:     LD  4,-10(1)	Load left into ac1 
226:    DIV  3,4,3	Op / 
227:     ST  3,-10(1)	Save left side 
228:    LDC  3,3(6)	Load integer constant 
229:     LD  4,-10(1)	Load left into ac1 
230:    MUL  3,4,3	Op * 
...
* IF
* CALL getValue
250:     ST  1,-9(1)	Store fp in ghost frame for getValue
* PARAM 1
...
* IF
* CALL getLocked
295:     ST  1,-4(1)	Store fp in ghost frame for getLocked
* PARAM 1
...
* RETURN
* CALL search
331:     ST  1,-4(1)	Store fp in ghost frame for search
* PARAM 1
...
* RETURN
* CALL search
349:     ST  1,-4(1)	Store fp in ghost frame for search
* PARAM 1
...
* IF
* CALL isOkAt
376:     ST  1,-6(1)	Store fp in ghost frame for isOkAt
* PARAM 1
...
* EXPRESSION
* CALL setValue
388:     ST  1,-6(1)	Store fp in ghost frame for setValue
* PARAM 1
...
* EXPRESSION
* CALL search
425:     ST  1,-7(1)	Store fp in ghost frame for search
* PARAM 1
...
430:    ADD  3,4,3	Op + 
431:     ST  3,-9(1)	Store parameter 
* PARAM 2
432:    LDC  3,0(6)	Load integer constant 
433:     ST  3,-10(1)	Store parameter 
* END PARAM search
434:    LDA  1,-7(1)	Load address of new frame 
...
* EXPRESSION
* CALL search
440:     ST  1,-7(1)	Store fp in ghost frame for search
* PARAM 1
441:     LD  3,-2(1)	Load variable i
442:     ST  3,-9(1)	Store parameter 
* PARAM 2
443:     LD  3,-3(1)	Load variable j
444:     ST  3,-10(1)	Save left side 
445:    LDC  3,1(6)	Load integer constant 
446:     LD  4,-10(1)	Load left into ac1 
447:    ADD  3,4,3	Op + 
448:     ST  3,-10(1)	Store parameter 
* END PARAM search
449:    LDA  1,-7(1)	Load address of new frame 
...
* EXPRESSION
* CALL setValue
462:     ST  1,-6(1)	Store fp in ghost frame for setValue
* PARAM 1
...
* IF
* CALL getLocked
512:     ST  1,-8(1)	Store fp in ghost frame for getLocked
* PARAM 1
...
* IF
* CALL isOkAt
537:     ST  1,-8(1)	Store fp in ghost frame for isOkAt
* PARAM 1
...
* EXPRESSION
* CALL setValue
565:     ST  1,-8(1)	Store fp in ghost frame for setValue
* PARAM 1
...
* EXPRESSION
* CALL setLocked
576:     ST  1,-8(1)	Store fp in ghost frame for setLocked
* PARAM 1
...
* EXPRESSION
* CALL getValue
621:     ST  1,-6(1)	Store fp in ghost frame for getValue
* PARAM 1
622:     LD  3,-2(1)	Load variable i
623:     ST  3,-8(1)	Store parameter 
* PARAM 2
624:     LD  3,-3(1)	Load variable j
625:     ST  3,-9(1)	Store parameter 
* END PARAM getValue
626:    LDA  1,-6(1)	Load address of new frame 
...
* EXPRESSION
* CALL setValue
631:     ST  1,-5(1)	Store fp in ghost frame for setValue
* PARAM 1
...
* IF
* CALL getLocked
642:     ST  1,-5(1)	Store fp in ghost frame for getLocked
* PARAM 1
...
* CALL isOkAt
656:     ST  1,-6(1)	Store fp in ghost frame for isOkAt
* PARAM 1
...
* EXPRESSION
* CALL setValue
679:     ST  1,-5(1)	Store fp in ghost frame for setValue
* PARAM 1
...
* EXPRESSION
* CALL searchTrivial
698:     ST  1,-5(1)	Store fp in ghost frame for searchTrivial
* END PARAM searchTrivial
...
* RETURN
* CALL search
703:     ST  1,-5(1)	Store fp in ghost frame for search
* PARAM 1
...
* EXPRESSION
* CALL outnl
721:     ST  1,-4(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL output
744:     ST  1,-4(1)	Store fp in ghost frame for output
* PARAM 1
* CALL getValue
745:     ST  1,-6(1)	Store fp in ghost frame for getValue
* PARAM 1
...
* EXPRESSION
* CALL outnl
763:     ST  1,-4(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL outnl
772:     ST  1,-4(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL input
800:     ST  1,-6(1)	Store fp in ghost frame for input
* END PARAM input
801:    LDA  1,-6(1)	Load address of new frame 
...
* EXPRESSION
* CALL setValue
820:     ST  1,-5(1)	Store fp in ghost frame for setValue
* PARAM 1
...
* EXPRESSION
* CALL setLocked
831:     ST  1,-5(1)	Store fp in ghost frame for setLocked
* PARAM 1
...
* EXPRESSION
* CALL outnl
846:     ST  1,-5(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL initBoard
860:     ST  1,-2(1)	Store fp in ghost frame for initBoard
* END PARAM initBoard
...
* EXPRESSION
* CALL getInput
865:     ST  1,-2(1)	Store fp in ghost frame for getInput
* END PARAM getInput
...
* IF
* CALL solve
870:     ST  1,-2(1)	Store fp in ghost frame for solve
* END PARAM solve
...
* EXPRESSION
* CALL showBoard
876:     ST  1,-2(1)	Store fp in ghost frame for showBoard
* END PARAM showBoard
...
* EXPRESSION
* CALL outputb
882:     ST  1,-2(1)	Store fp in ghost frame for outputb
* PARAM 1
...
* EXPRESSION
* CALL outnl
889:     ST  1,-2(1)	Store fp in ghost frame for outnl
* END PARAM outnl
