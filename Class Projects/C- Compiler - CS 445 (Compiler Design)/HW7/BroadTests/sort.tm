...
* EXPRESSION
 ...
 48:     LD  4,-9(1)	Load left into ac1 
...
* EXPRESSION
 ...
 53:     ST  3,-9(1)	Save left side 
 54:    LDC  3,1(6)	Load integer constant 
 55:     LD  4,-9(1)	Load left into ac1 
 56:    ADD  3,4,3	Op + 
...
* EXPRESSION
 ...
 77:     ST  3,-9(1)	Save left side 
 78:     LD  3,-5(1)	Load variable i
 79:     LD  4,-9(1)	Load left into ac1 
...
* EXPRESSION
* CALL minloc
112:     ST  1,-9(1)	Store fp in ghost frame for minloc
* PARAM 1
113:     LD  3,-2(1)	Load address of base of array a
114:     ST  3,-11(1)	Store parameter 
* PARAM 2
115:     LD  3,-5(1)	Load variable i
116:     ST  3,-12(1)	Store parameter 
* PARAM 3
117:     LD  3,-4(1)	Load variable high
118:     ST  3,-13(1)	Store parameter 
* END PARAM minloc
119:    LDA  1,-9(1)	Load address of new frame 
...
* CALL input
170:     ST  1,-4(1)	Store fp in ghost frame for input
* END PARAM input
...
* EXPRESSION
* CALL sort
183:     ST  1,-3(1)	Store fp in ghost frame for sort
* PARAM 1
...
* EXPRESSION
* CALL output
203:     ST  1,-3(1)	Store fp in ghost frame for output
* PARAM 1
