...
102:     ST  3,-9(1)	Save left side 
103:    LDC  3,1(6)	Load integer constant 
104:     LD  4,-9(1)	Load left into ac1 
105:    ADD  3,4,3	Op + 
...
* EXPRESSION
* CALL output
132:     ST  1,-8(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
139:     ST  1,-8(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
146:     ST  1,-8(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
153:     ST  1,-8(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
172:    ADD  3,4,3	Op + 
173:     ST  3,-9(1)	Save left side 
174:    LDC  3,1(6)	Load integer constant 
175:     LD  4,-9(1)	Load left into ac1 
176:    SUB  3,4,3	Op - 
...
180:     ST  3,-9(1)	Save left side 
181:    LDC  3,1(6)	Load integer constant 
182:     LD  4,-9(1)	Load left into ac1 
183:    ADD  3,4,3	Op + 
...
190:     LD  4,-10(1)	Load left into ac1 
191:    MUL  3,4,3	Op * 
