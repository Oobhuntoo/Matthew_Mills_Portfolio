...
* EXPRESSION
* CALL outnl
108:     ST  1,-2(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL output
162:     ST  1,-2(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
177:     ST  1,-2(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
207:     ST  1,-2(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
237:     ST  1,-2(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL output
242:     ST  1,-2(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
257:     ST  1,-2(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
272:     ST  1,-2(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL output
277:     ST  1,-2(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
290:     ST  1,-2(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
305:     ST  1,-2(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
320:     ST  1,-2(1)	Store fp in ghost frame for output
* PARAM 1
