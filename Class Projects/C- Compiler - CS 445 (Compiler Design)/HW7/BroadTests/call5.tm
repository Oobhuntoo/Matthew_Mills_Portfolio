...
* PARAM 1
* CALL dog
105:     ST  1,-4(1)	Store fp in ghost frame for dog
* PARAM 1
...
* EXPRESSION
* CALL cat
124:     ST  1,-2(1)	Store fp in ghost frame for cat
* PARAM 1
...
* EXPRESSION
* CALL elk
138:     ST  1,-2(1)	Store fp in ghost frame for elk
* PARAM 1
...
* EXPRESSION
* CALL output
145:     ST  1,-2(1)	Store fp in ghost frame for output
* PARAM 1
...
* PARAM 1
* CALL fox
153:     ST  1,-4(1)	Store fp in ghost frame for fox
* PARAM 1
...
* EXPRESSION
* CALL output
165:     ST  1,-2(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
172:     ST  1,-2(1)	Store fp in ghost frame for outnl
* END PARAM outnl
