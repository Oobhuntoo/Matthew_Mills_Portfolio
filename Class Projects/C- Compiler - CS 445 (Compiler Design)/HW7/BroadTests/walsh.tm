...
* IF
* CALL input
 97:     ST  1,-7(1)	Store fp in ghost frame for input
* END PARAM input
...
* EXPRESSION
* CALL pow
113:     ST  1,-7(1)	Store fp in ghost frame for pow
* PARAM 1
114:    LDC  3,2(6)	Load integer constant 
115:     ST  3,-9(1)	Store parameter 
* PARAM 2
116:     LD  3,-3(1)	Load variable numbits
117:     ST  3,-10(1)	Store parameter 
* END PARAM pow
118:    LDA  1,-7(1)	Load address of new frame 
...
* CALL input
134:     ST  1,-7(1)	Store fp in ghost frame for input
* END PARAM input
...
* EXPRESSION
* CALL output
169:     ST  1,-5(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
188:     ST  1,-5(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL fwt
210:     ST  1,-8(1)	Store fp in ghost frame for fwt
* PARAM 1
...
* EXPRESSION
* CALL fwt
221:     ST  1,-8(1)	Store fp in ghost frame for fwt
* PARAM 1
...
* IF
* CALL getFunc
356:     ST  1,-263(1)	Store fp in ghost frame for getFunc
* PARAM 1
...
* END CALL getFunc
363:     ST  3,-260(1)	Store variable numbits
364:     ST  3,-262(1)	Save left side 
365:    LDC  3,0(6)	Load integer constant 
366:     LD  4,-262(1)	Load left into ac1 
367:    TEQ  3,4,3	Op == 
* THEN
* RETURN
...
* EXPRESSION
* CALL pow
374:     ST  1,-263(1)	Store fp in ghost frame for pow
* PARAM 1
375:    LDC  3,2(6)	Load integer constant 
376:     ST  3,-265(1)	Store parameter 
* PARAM 2
377:     LD  3,-260(1)	Load variable numbits
...
* END CALL pow
383:     ST  3,-259(1)	Store variable size
* EXPRESSION
384:     LD  3,-259(1)	Load variable size
385:     ST  3,-263(1)	Save left side 
386:    LDC  3,2(6)	Load integer constant 
387:     LD  4,-263(1)	Load left into ac1 
388:    DIV  3,4,3	Op / 
389:     ST  3,-261(1)	Store variable half
* EXPRESSION
* CALL fwt
390:     ST  1,-262(1)	Store fp in ghost frame for fwt
* PARAM 1
391:    LDA  3,-3(1)	Load address of base of array f
392:     ST  3,-264(1)	Store parameter 
* PARAM 2
393:    LDC  3,0(6)	Load integer constant 
394:     ST  3,-265(1)	Store parameter 
* PARAM 3
395:     LD  3,-259(1)	Load variable size
396:     ST  3,-266(1)	Store parameter 
* END PARAM fwt
397:    LDA  1,-262(1)	Load address of new frame 
...
* EXPRESSION
* CALL printFunc
401:     ST  1,-262(1)	Store fp in ghost frame for printFunc
* PARAM 1
402:    LDA  3,-3(1)	Load address of base of array f
403:     ST  3,-264(1)	Store parameter 
* PARAM 2
404:     LD  3,-259(1)	Load variable size
405:     ST  3,-265(1)	Store parameter 
* END PARAM printFunc
406:    LDA  1,-262(1)	Load address of new frame 
...
* EXPRESSION
* CALL fwt
410:     ST  1,-262(1)	Store fp in ghost frame for fwt
* PARAM 1
...
* PARAM 3
415:     LD  3,-259(1)	Load variable size
416:     ST  3,-266(1)	Store parameter 
* END PARAM fwt
417:    LDA  1,-262(1)	Load address of new frame 
...
* EXPRESSION
* CALL div
421:     ST  1,-262(1)	Store fp in ghost frame for div
* PARAM 1
422:    LDA  3,-3(1)	Load address of base of array f
423:     ST  3,-264(1)	Store parameter 
* PARAM 2
424:     LD  3,-259(1)	Load variable size
425:     ST  3,-265(1)	Store parameter 
* END PARAM div
426:    LDA  1,-262(1)	Load address of new frame 
...
* EXPRESSION
* CALL printFunc
430:     ST  1,-262(1)	Store fp in ghost frame for printFunc
* PARAM 1
431:    LDA  3,-3(1)	Load address of base of array f
432:     ST  3,-264(1)	Store parameter 
* PARAM 2
433:     LD  3,-259(1)	Load variable size
434:     ST  3,-265(1)	Store parameter 
* END PARAM printFunc
435:    LDA  1,-262(1)	Load address of new frame 
