...
* EXPRESSION
* CALL outputb
 63:     ST  1,-6(1)	Store fp in ghost frame for outputb
* PARAM 1
...
* EXPRESSION
* CALL outnl
 79:     ST  1,-6(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL output
 86:     ST  1,-6(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
 95:     ST  1,-6(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outputb
104:     ST  1,-6(1)	Store fp in ghost frame for outputb
* PARAM 1
...
* EXPRESSION
* CALL outputb
113:     ST  1,-6(1)	Store fp in ghost frame for outputb
* PARAM 1
...
* EXPRESSION
* CALL outnl
120:     ST  1,-6(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL outputb
136:     ST  1,-6(1)	Store fp in ghost frame for outputb
* PARAM 1
...
* EXPRESSION
* CALL output
150:     ST  1,-6(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outputb
159:     ST  1,-6(1)	Store fp in ghost frame for outputb
* PARAM 1
...
* EXPRESSION
* CALL outnl
166:     ST  1,-6(1)	Store fp in ghost frame for outnl
* END PARAM outnl
