...
* EXPRESSION
* CALL output
 45:     ST  1,-6(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
106:     ST  1,-6(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
123:     ST  1,-6(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
130:     ST  1,-6(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
174:     LD  3,-1(0)	load lhs variable s
175:    LDA  3,1(3)	increment value of s
176:     ST  3,-1(0)	Store variable s
* EXPRESSION
* CALL output
177:     ST  1,-4(1)	Store fp in ghost frame for output
* PARAM 1
178:     LD  3,-1(0)	Load variable s
179:     ST  3,-6(1)	Store parameter 
* END PARAM output
180:    LDA  1,-4(1)	Load address of new frame 
...
* PARAM 1
185:     LD  3,-1(0)	load lhs variable s
186:    LDA  3,1(3)	increment value of s
187:     ST  3,-1(0)	Store variable s
...
203:    LDA  1,-2(0)	set first frame at end of globals 
