...
* EXPRESSION
 ...
 76:    ADD  3,4,3	Op + 
 77:     LD  4,-12(1)	Load left into ac1 
 78:    SUB  3,4,3	Op - 
...
106:     ST  3,-12(1)	Save left side 
107:    LDC  3,1(6)	Load integer constant 
108:     LD  4,-12(1)	Load left into ac1 
109:    ADD  3,4,3	Op + 
...
118:     ST  3,-12(1)	Save left side 
119:    LDC  3,1(6)	Load integer constant 
120:     LD  4,-12(1)	Load left into ac1 
121:    ADD  3,4,3	Op + 
...
126:     ST  3,-13(1)	Save left side 
127:    LDC  3,1(6)	Load integer constant 
128:     LD  4,-13(1)	Load left into ac1 
129:    ADD  3,4,3	Op + 
130:     LD  4,-12(1)	Load left into ac1 
131:    MUL  3,4,3	Op * 
...
136:     ST  3,-13(1)	Save left side 
137:    LDC  3,1(6)	Load integer constant 
138:     LD  4,-13(1)	Load left into ac1 
139:    ADD  3,4,3	Op + 
140:     LD  4,-12(1)	Load left into ac1 
141:    MUL  3,4,3	Op * 
142:     ST  3,-12(1)	Save left side 
143:    LDC  3,1(6)	Load integer constant 
144:     ST  3,-13(1)	Save left side 
145:    LDC  3,1(6)	Load integer constant 
146:     LD  4,-13(1)	Load left into ac1 
147:    ADD  3,4,3	Op + 
...
159:    SUB  3,4,3	Op - 
160:     ST  3,-12(1)	Save left side 
161:    LDC  3,0(6)	Load integer constant 
162:     LD  4,-12(1)	Load left into ac1 
163:    ADD  3,4,3	Op + 
...
169:    DIV  3,4,3	Op / 
170:     ST  3,-12(1)	Save left side 
171:    LDC  3,1(6)	Load integer constant 
172:     LD  4,-12(1)	Load left into ac1 
173:    MUL  3,4,3	Op * 
...
* EXPRESSION
* CALL output
182:     ST  1,-11(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
189:     ST  1,-11(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
196:     ST  1,-11(1)	Store fp in ghost frame for output
* PARAM 1
...
210:     ST  3,-12(1)	Save left side 
211:    LDC  3,1(6)	Load integer constant 
212:     LD  4,-12(1)	Load left into ac1 
213:    ADD  3,4,3	Op + 
