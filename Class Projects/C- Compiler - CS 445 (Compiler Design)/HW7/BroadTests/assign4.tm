...
* EXPRESSION
* CALL output
 74:     ST  1,-4(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
101:     ST  1,-4(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
108:     ST  1,-4(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL output
117:     ST  1,-4(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
124:     ST  1,-4(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL output
144:     ST  1,-4(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
151:     ST  1,-4(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL output
171:     ST  1,-4(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
178:     ST  1,-4(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL output
187:     ST  1,-4(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
194:     ST  1,-4(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL output
203:     ST  1,-4(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
210:     ST  1,-4(1)	Store fp in ghost frame for outnl
* END PARAM outnl
