...
* EXPRESSION
* CALL printboard
 87:     ST  1,-4(1)	Store fp in ghost frame for printboard
* PARAM 1
...
* EXPRESSION
* CALL try
201:     ST  1,-4(1)	Store fp in ghost frame for try
* PARAM 1
...
235:     LD  4,-6(1)	Load left into ac1 
236:    SUB  3,4,3	Op - 
...
* EXPRESSION
* CALL try
262:     ST  1,-3(1)	Store fp in ghost frame for try
* PARAM 1
...
* WHILE
* CALL input
279:     ST  1,-4(1)	Store fp in ghost frame for input
* END PARAM input
280:    LDA  1,-4(1)	Load address of new frame 
...
* EXPRESSION
* CALL output
291:     ST  1,-3(1)	Store fp in ghost frame for output
* PARAM 1
* CALL solve
292:     ST  1,-5(1)	Store fp in ghost frame for solve
* PARAM 1
...
* EXPRESSION
* CALL outnl
304:     ST  1,-3(1)	Store fp in ghost frame for outnl
* END PARAM outnl
