...
* EXPRESSION
 ...
 48:     ST  3,-353(1)	Save left side 
 49:    LDC  3,10(6)	Load integer constant 
 50:     LD  4,-353(1)	Load left into ac1 
 51:    MUL  3,4,3	Op * 
 52:     ST  3,-353(1)	Save left side 
 53:    LDC  3,3(6)	Load integer constant 
 54:     LD  4,-353(1)	Load left into ac1 
 55:    DIV  3,4,3	Op / 
...
152:     ST  3,-354(1)	Save left side 
153:     LD  3,-4(1)	Load variable i
154:     LD  4,-354(1)	Load left into ac1 
155:    MUL  3,4,3	Op * 
156:     ST  3,-354(1)	Save left side 
157:    LDC  3,1(6)	Load integer constant 
158:     LD  4,-354(1)	Load left into ac1 
159:    SUB  3,4,3	Op - 
160:     LD  4,-353(1)	Load left into ac1 
161:    DIV  3,4,3	Op / 
...
182:     ST  3,-353(1)	Save left side 
183:    LDC  3,10(6)	Load integer constant 
184:     LD  4,-353(1)	Load left into ac1 
185:    DIV  3,4,3	Op / 
...
* EXPRESSION
* CALL output
203:     ST  1,-352(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
214:     ST  1,-352(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL output
228:     ST  1,-352(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
235:     ST  1,-352(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL output
245:     ST  1,-352(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
252:     ST  1,-352(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL output
266:     ST  1,-352(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
273:     ST  1,-352(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL output
286:     ST  1,-352(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
293:     ST  1,-352(1)	Store fp in ghost frame for outnl
* END PARAM outnl
