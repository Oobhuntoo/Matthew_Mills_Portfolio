...
* EXPRESSION
* CALL output
 45:     ST  1,-4(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
 64:     ST  1,-4(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL outnl
 80:     ST  1,-4(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL output
109:     ST  1,-3(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
131:     ST  1,-3(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
138:     ST  1,-3(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL dog
143:     ST  1,-3(1)	Store fp in ghost frame for dog
* PARAM 1
...
182:     ST  3,-10(0)	Store variable z
183:    LDC  3,555(6)	Load integer constant 
184:     ST  3,-11(0)	Store variable z
