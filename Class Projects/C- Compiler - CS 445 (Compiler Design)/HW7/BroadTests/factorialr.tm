...
* CALL factorial
 57:     ST  1,-4(1)	Store fp in ghost frame for factorial
* PARAM 1
...
* EXPRESSION
* CALL input
 79:     ST  1,-4(1)	Store fp in ghost frame for input
* END PARAM input
...
* EXPRESSION
* CALL factorial
 85:     ST  1,-4(1)	Store fp in ghost frame for factorial
* PARAM 1
...
* EXPRESSION
* CALL output
 93:     ST  1,-3(1)	Store fp in ghost frame for output
* PARAM 1
