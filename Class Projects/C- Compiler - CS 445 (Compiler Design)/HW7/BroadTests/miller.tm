...
* EXPRESSION
* CALL outnl
 71:     ST  1,-5(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL outnl
102:     ST  1,-4(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL outnl
119:     ST  1,-4(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL dog
188:     ST  1,-58(1)	Store fp in ghost frame for dog
* PARAM 1
...
* EXPRESSION
* CALL dog
209:     ST  1,-58(1)	Store fp in ghost frame for dog
* PARAM 1
...
* EXPRESSION
* CALL dog
249:     ST  1,-58(1)	Store fp in ghost frame for dog
* PARAM 1
...
* EXPRESSION
* CALL dog
294:     ST  1,-58(1)	Store fp in ghost frame for dog
* PARAM 1
...
* EXPRESSION
* CALL dog
369:     ST  1,-58(1)	Store fp in ghost frame for dog
* PARAM 1
...
425:     ST  3,-59(1)	Save left side 
426:    LDC  3,2(6)	Load integer constant 
427:     LD  4,-59(1)	Load left into ac1 
...
* EXPRESSION
* CALL output
486:     ST  1,-58(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
498:     ST  1,-58(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL dog
526:     ST  1,-58(1)	Store fp in ghost frame for dog
* PARAM 1
...
551:     ST  3,-59(1)	Save left side 
552:    LDC  3,9(6)	Load integer constant 
553:     LD  4,-59(1)	Load left into ac1 
...
560:     ST  3,-59(1)	Save left side 
561:    LDC  3,9(6)	Load integer constant 
562:     LD  4,-59(1)	Load left into ac1 
...
* CALL getnxtindex
579:     ST  1,-60(1)	Store fp in ghost frame for getnxtindex
* PARAM 1
580:    LDC  3,7(6)	Load integer constant 
581:     ST  3,-62(1)	Store parameter 
* END PARAM getnxtindex
...
* EXPRESSION
* CALL dog
597:     ST  1,-58(1)	Store fp in ghost frame for dog
* PARAM 1
...
* EXPRESSION
* CALL dog
678:     ST  1,-58(1)	Store fp in ghost frame for dog
* PARAM 1
...
699:     ST  3,-61(1)	Save left side 
700:     LD  3,-59(1)	Load variable q
701:     LD  4,-61(1)	Load left into ac1 
702:    SUB  3,4,3	Op - 
...
* EXPRESSION
* CALL showIntArray
713:     ST  1,-58(1)	Store fp in ghost frame for showIntArray
* PARAM 1
