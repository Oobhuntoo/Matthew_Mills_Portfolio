...
* EXPRESSION
 ...
 84:     ST  3,-208(1)	Save left side 
 85:     LD  3,-3(1)	Load variable k
 86:     LD  4,-208(1)	Load left into ac1 
 87:    MUL  3,4,3	Op * 
...
104:     ST  3,-208(1)	Save left side 
105:     LD  3,-3(1)	Load variable k
106:     LD  4,-208(1)	Load left into ac1 
107:    ADD  3,4,3	Op + 
...
111:     ST  3,-208(1)	Save left side 
112:    LDC  3,1(6)	Load integer constant 
113:     LD  4,-208(1)	Load left into ac1 
114:    ADD  3,4,3	Op + 
...
135:     ST  3,-208(1)	Save left side 
136:    LDC  3,1(6)	Load integer constant 
137:     LD  4,-208(1)	Load left into ac1 
138:    ADD  3,4,3	Op + 
...
152:     ST  3,-206(1)	Save left side 
153:     LD  3,-3(1)	Load variable k
154:     LD  4,-206(1)	Load left into ac1 
...
* EXPRESSION
* CALL output
158:     ST  1,-206(1)	Store fp in ghost frame for output
* PARAM 1
159:     LD  3,-3(1)	Load variable k
160:     ST  3,-208(1)	Store parameter 
* END PARAM output
161:    LDA  1,-206(1)	Load address of new frame 
...
* EXPRESSION
* CALL outnl
165:     ST  1,-206(1)	Store fp in ghost frame for outnl
* END PARAM outnl
166:    LDA  1,-206(1)	Load address of new frame 
