...
* EXPRESSION
* CALL output
 59:     ST  1,-7(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
 66:     ST  1,-7(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
 73:     ST  1,-7(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
 80:     ST  1,-7(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
 87:     ST  1,-7(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
 94:     ST  1,-7(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL output
 99:     ST  1,-5(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
127:     ST  1,-5(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL output
199:     ST  1,-3(1)	Store fp in ghost frame for output
* PARAM 1
* CALL ant
200:     ST  1,-5(1)	Store fp in ghost frame for ant
* PARAM 1
...
* EXPRESSION
* CALL output
219:     ST  1,-3(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
226:     ST  1,-3(1)	Store fp in ghost frame for outnl
* END PARAM outnl
