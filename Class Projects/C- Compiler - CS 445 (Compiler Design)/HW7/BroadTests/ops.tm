...
* EXPRESSION
* CALL outnl
444:     ST  1,-6(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL output
449:     ST  1,-6(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
460:     ST  1,-6(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
476:     ST  1,-6(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL output
481:     ST  1,-6(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
492:     ST  1,-6(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
507:     ST  1,-6(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL output
512:     ST  1,-6(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
521:     ST  1,-6(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
530:     ST  1,-6(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
539:     ST  1,-6(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL output
544:     ST  1,-6(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
567:     ST  1,-6(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
583:     ST  1,-6(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
599:     ST  1,-6(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL output
604:     ST  1,-6(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
620:     ST  1,-6(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
636:     ST  1,-6(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
652:     ST  1,-6(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
667:     ST  1,-6(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL output
672:     ST  1,-6(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
685:     ST  1,-6(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
698:     ST  1,-6(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
711:     ST  1,-6(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
743:     ST  1,-6(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL output
748:     ST  1,-6(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
758:     ST  1,-6(1)	Store fp in ghost frame for output
* PARAM 1
...
767:     ST  3,-7(1)	Save left side 
768:    LDC  3,4(6)	Load integer constant 
769:     ST  3,-4(1)	Store variable c
770:     LD  4,-7(1)	Load left into ac1 
771:    MUL  3,4,3	Op * 
772:     ST  3,-2(1)	Store variable a
* EXPRESSION
* CALL output
773:     ST  1,-6(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
780:     ST  1,-6(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL output
789:     ST  1,-6(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
799:     ST  1,-6(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
809:     ST  1,-6(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
832:     ST  1,-6(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL output
837:     ST  1,-6(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
867:     ST  1,-6(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outputb
882:     ST  1,-6(1)	Store fp in ghost frame for outputb
* PARAM 1
...
* EXPRESSION
* CALL outputb
897:     ST  1,-6(1)	Store fp in ghost frame for outputb
* PARAM 1
...
* EXPRESSION
* CALL outputb
912:     ST  1,-6(1)	Store fp in ghost frame for outputb
* PARAM 1
...
* EXPRESSION
* CALL outnl
927:     ST  1,-6(1)	Store fp in ghost frame for outnl
* END PARAM outnl
