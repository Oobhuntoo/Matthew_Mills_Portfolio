...
* EXPRESSION
* CALL outputb
153:     ST  1,-2(1)	Store fp in ghost frame for outputb
* PARAM 1
...
* EXPRESSION
* CALL outputb
164:     ST  1,-2(1)	Store fp in ghost frame for outputb
* PARAM 1
...
* EXPRESSION
* CALL outputb
175:     ST  1,-2(1)	Store fp in ghost frame for outputb
* PARAM 1
...
* EXPRESSION
* CALL outputb
197:     ST  1,-2(1)	Store fp in ghost frame for outputb
* PARAM 1
198:    LDC  3,3(6)	Load integer constant 
...
* EXPRESSION
* CALL outputb
208:     ST  1,-2(1)	Store fp in ghost frame for outputb
* PARAM 1
...
* EXPRESSION
* CALL outputb
219:     ST  1,-2(1)	Store fp in ghost frame for outputb
* PARAM 1
...
* PARAM 1
231:    LDC  3,3(6)	Load integer constant 
