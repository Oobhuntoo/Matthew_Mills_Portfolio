...
* IF
* CALL search
185:     ST  1,-5(1)	Store fp in ghost frame for search
* PARAM 1
...
* EXPRESSION
* CALL outnl
221:     ST  1,-5(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL outnl
258:     ST  1,-3(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* CALL input
280:     ST  1,-4(1)	Store fp in ghost frame for input
* END PARAM input
...
* IF
* CALL check
338:     ST  1,-3(1)	Store fp in ghost frame for check
* END PARAM check
...
* EXPRESSION
* CALL outputb
353:     ST  1,-3(1)	Store fp in ghost frame for outputb
* PARAM 1
...
* EXPRESSION
* CALL outnl
364:     ST  1,-3(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL outputb
389:     ST  1,-3(1)	Store fp in ghost frame for outputb
* PARAM 1
...
* EXPRESSION
* CALL outnl
400:     ST  1,-3(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* CALL input
419:     ST  1,-4(1)	Store fp in ghost frame for input
* END PARAM input
...
* EXPRESSION
* CALL outnl
428:     ST  1,-3(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* CALL rand
444:     ST  1,-4(1)	Store fp in ghost frame for rand
* END PARAM rand
...
* WHILE
* CALL turn
465:     ST  1,-3(1)	Store fp in ghost frame for turn
* END PARAM turn
...
* EXPRESSION
* CALL outnl
473:     ST  1,-3(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL output
487:     ST  1,-3(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
499:     ST  1,-3(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL outnl
508:     ST  1,-3(1)	Store fp in ghost frame for outnl
* END PARAM outnl
