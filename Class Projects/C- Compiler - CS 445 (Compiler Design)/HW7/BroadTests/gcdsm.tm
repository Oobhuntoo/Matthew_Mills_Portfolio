...
* EXPRESSION
* CALL input
 85:     ST  1,-5(1)	Store fp in ghost frame for input
* END PARAM input
...
* EXPRESSION
* CALL input
 91:     ST  1,-5(1)	Store fp in ghost frame for input
* END PARAM input
...
* EXPRESSION
* CALL output
 97:     ST  1,-4(1)	Store fp in ghost frame for output
* PARAM 1
* CALL gcd
 98:     ST  1,-6(1)	Store fp in ghost frame for gcd
* PARAM 1
