...
* EXPRESSION
* CALL output
 86:     ST  1,-7(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
 98:     ST  1,-7(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
110:     ST  1,-7(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL show
115:     ST  1,-7(1)	Store fp in ghost frame for show
* PARAM 1
...
* EXPRESSION
* CALL show
124:     ST  1,-7(1)	Store fp in ghost frame for show
* PARAM 1
...
* EXPRESSION
* CALL outnl
133:     ST  1,-7(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL output
138:     ST  1,-7(1)	Store fp in ghost frame for output
* PARAM 1
* CALL show
139:     ST  1,-9(1)	Store fp in ghost frame for show
* PARAM 1
...
* EXPRESSION
* CALL output
153:     ST  1,-7(1)	Store fp in ghost frame for output
* PARAM 1
* CALL show
154:     ST  1,-9(1)	Store fp in ghost frame for show
* PARAM 1
...
* EXPRESSION
* CALL outnl
168:     ST  1,-7(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL output
191:     ST  1,-7(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
203:     ST  1,-7(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
215:     ST  1,-7(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL output
220:     ST  1,-7(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
235:     ST  1,-7(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
250:     ST  1,-7(1)	Store fp in ghost frame for outnl
* END PARAM outnl
