...
* IF
* CALL win
1786:     ST  1,-2(1)	Store fp in ghost frame for win
* END PARAM win
...
* IF
* CALL blockplayer
1794:     ST  1,-2(1)	Store fp in ghost frame for blockplayer
* END PARAM blockplayer
...
* EXPRESSION
* CALL move
1802:     ST  1,-2(1)	Store fp in ghost frame for move
* END PARAM move
...
* EXPRESSION
* CALL outputb
1891:     ST  1,-3(1)	Store fp in ghost frame for outputb
* PARAM 1
...
* EXPRESSION
* CALL outputb
1910:     ST  1,-3(1)	Store fp in ghost frame for outputb
* PARAM 1
...
* EXPRESSION
* CALL output
1918:     ST  1,-3(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
1947:     ST  1,-3(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL outnl
2391:     ST  1,-3(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL printboard
2396:     ST  1,-3(1)	Store fp in ghost frame for printboard
* END PARAM printboard
...
* WHILE
* CALL finished
2401:     ST  1,-3(1)	Store fp in ghost frame for finished
* END PARAM finished
...
* EXPRESSION
* CALL input
2418:     ST  1,-4(1)	Store fp in ghost frame for input
* END PARAM input
2419:    LDA  1,-4(1)	Load address of new frame 
...
* IF
* CALL xingrid
2424:     ST  1,-3(1)	Store fp in ghost frame for xingrid
* PARAM 1
...
* CALL finished
2432:     ST  1,-4(1)	Store fp in ghost frame for finished
* END PARAM finished
...
* EXPRESSION
* CALL placey
2442:     ST  1,-3(1)	Store fp in ghost frame for placey
* END PARAM placey
...
* EXPRESSION
* CALL outnl
2447:     ST  1,-3(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL printboard
2452:     ST  1,-3(1)	Store fp in ghost frame for printboard
* END PARAM printboard
...
* EXPRESSION
* CALL outnl
2457:     ST  1,-3(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL playgame
2492:     ST  1,-3(1)	Store fp in ghost frame for playgame
* END PARAM playgame
...
* EXPRESSION
* CALL outnl
2497:     ST  1,-3(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL printboard
2502:     ST  1,-3(1)	Store fp in ghost frame for printboard
* END PARAM printboard
...
* EXPRESSION
* CALL outnl
2507:     ST  1,-3(1)	Store fp in ghost frame for outnl
* END PARAM outnl
