...
* EXPRESSION
 ...
 91:    DIV  3,4,3	Op / 
 92:     ST  3,-6(1)	Save left side 
 93:     LD  3,-3(1)	Load variable guess
 94:     LD  4,-6(1)	Load left into ac1 
 95:    ADD  3,4,3	Op + 
...
* WHILE
* CALL input
128:     ST  1,-5(1)	Store fp in ghost frame for input
* END PARAM input
...
* EXPRESSION
* CALL sqrt
140:     ST  1,-6(1)	Store fp in ghost frame for sqrt
* PARAM 1
...
* EXPRESSION
* CALL output
197:     ST  1,-5(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL sqrt
210:     ST  1,-6(1)	Store fp in ghost frame for sqrt
* PARAM 1
...
* EXPRESSION
* CALL output
232:     ST  1,-5(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
239:     ST  1,-5(1)	Store fp in ghost frame for outnl
* END PARAM outnl
