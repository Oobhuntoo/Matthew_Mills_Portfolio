...
* EXPRESSION
* CALL output
 72:     ST  1,-4(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
109:     ST  1,-4(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
116:     ST  1,-4(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
128:     ST  1,-4(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL output
146:     ST  1,-4(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
153:     ST  1,-4(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
165:     ST  1,-4(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL cat
170:     ST  1,-4(1)	Store fp in ghost frame for cat
* PARAM 1
...
* EXPRESSION
* CALL cat
179:     ST  1,-4(1)	Store fp in ghost frame for cat
* PARAM 1
...
* EXPRESSION
* CALL outnl
227:     ST  1,-14(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL dog
232:     ST  1,-14(1)	Store fp in ghost frame for dog
* PARAM 1
...
* EXPRESSION
* CALL output
241:     ST  1,-14(1)	Store fp in ghost frame for output
* PARAM 1
