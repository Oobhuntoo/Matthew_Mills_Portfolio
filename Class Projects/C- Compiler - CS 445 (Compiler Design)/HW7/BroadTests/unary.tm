...
* EXPRESSION
 ...
 50:     ST  3,-19(1)	Save left side 
 51:    LDC  3,9(6)	Load integer constant 
 52:     LD  4,-19(1)	Load left into ac1 
 53:    SUB  3,4,3	Op - 
...
* EXPRESSION
* CALL outnl
 75:     ST  1,-18(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL output
 80:     ST  1,-18(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
 97:     ST  1,-18(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
108:     ST  1,-18(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL outputb
119:     ST  1,-20(1)	Store fp in ghost frame for outputb
* PARAM 1
...
* EXPRESSION
* CALL outputb
128:     ST  1,-20(1)	Store fp in ghost frame for outputb
* PARAM 1
...
* EXPRESSION
* CALL outputb
135:     ST  1,-20(1)	Store fp in ghost frame for outputb
* PARAM 1
...
* EXPRESSION
* CALL outputb
169:     ST  1,-20(1)	Store fp in ghost frame for outputb
* PARAM 1
...
* EXPRESSION
* CALL outputb
186:     ST  1,-20(1)	Store fp in ghost frame for outputb
* PARAM 1
...
* EXPRESSION
* CALL outnl
197:     ST  1,-20(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL output
202:     ST  1,-18(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
210:     ST  1,-18(1)	Store fp in ghost frame for output
* PARAM 1
