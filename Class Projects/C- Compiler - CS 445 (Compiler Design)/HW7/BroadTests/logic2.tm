...
* EXPRESSION
* CALL outputb
 43:     ST  1,-4(1)	Store fp in ghost frame for outputb
* PARAM 1
...
* EXPRESSION
* CALL outputb
 64:     ST  1,-4(1)	Store fp in ghost frame for outputb
* PARAM 1
...
* EXPRESSION
* CALL outputb
 75:     ST  1,-4(1)	Store fp in ghost frame for outputb
* PARAM 1
...
* EXPRESSION
* CALL outputb
 86:     ST  1,-4(1)	Store fp in ghost frame for outputb
* PARAM 1
...
* EXPRESSION
* CALL outnl
 95:     ST  1,-4(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL outputb
100:     ST  1,-4(1)	Store fp in ghost frame for outputb
* PARAM 1
...
* EXPRESSION
* CALL outputb
111:     ST  1,-4(1)	Store fp in ghost frame for outputb
* PARAM 1
...
* EXPRESSION
* CALL outputb
122:     ST  1,-4(1)	Store fp in ghost frame for outputb
* PARAM 1
...
* EXPRESSION
* CALL outputb
133:     ST  1,-4(1)	Store fp in ghost frame for outputb
* PARAM 1
...
* EXPRESSION
* CALL outputb
144:     ST  1,-4(1)	Store fp in ghost frame for outputb
* PARAM 1
...
* EXPRESSION
* CALL outputb
155:     ST  1,-4(1)	Store fp in ghost frame for outputb
* PARAM 1
...
* EXPRESSION
* CALL outnl
166:     ST  1,-4(1)	Store fp in ghost frame for outnl
* END PARAM outnl
