...
* EXPRESSION
* CALL output
119:     ST  1,-6(1)	Store fp in ghost frame for output
* PARAM 1
* CALL square
120:     ST  1,-8(1)	Store fp in ghost frame for square
* PARAM 1
...
* EXPRESSION
* CALL outnl
132:     ST  1,-6(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL output
137:     ST  1,-6(1)	Store fp in ghost frame for output
* PARAM 1
* CALL max
138:     ST  1,-8(1)	Store fp in ghost frame for max
* PARAM 1
...
* EXPRESSION
* CALL outnl
152:     ST  1,-6(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL toBool
157:     ST  1,-7(1)	Store fp in ghost frame for toBool
* PARAM 1
158:    LDC  3,42(6)	Load integer constant 
159:     ST  3,-9(1)	Store parameter 
* END PARAM toBool
160:    LDA  1,-7(1)	Load address of new frame 
...
* EXPRESSION
* CALL toInt
165:     ST  1,-7(1)	Store fp in ghost frame for toInt
* PARAM 1
166:    LDC  3,1(6)	Load Boolean constant 
167:     ST  3,-9(1)	Store parameter 
* END PARAM toInt
168:    LDA  1,-7(1)	Load address of new frame 
...
* EXPRESSION
* CALL output
173:     ST  1,-6(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outputb
180:     ST  1,-6(1)	Store fp in ghost frame for outputb
* PARAM 1
...
* EXPRESSION
* CALL output
199:     ST  1,-6(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
207:     ST  1,-6(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
230:     ST  1,-6(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
238:     ST  1,-6(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
263:     ST  1,-6(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
271:     ST  1,-6(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
286:     ST  1,-6(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
309:     ST  1,-6(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
316:     ST  1,-6(1)	Store fp in ghost frame for outnl
* END PARAM outnl
