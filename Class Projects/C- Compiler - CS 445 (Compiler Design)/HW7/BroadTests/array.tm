...
* EXPRESSION
* CALL output
 93:     ST  1,-9(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
117:     ST  1,-9(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
145:     ST  1,-9(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
168:     ST  1,-9(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
180:     ST  1,-9(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL output
194:     ST  1,-9(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
218:     ST  1,-9(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
246:     ST  1,-9(1)	Store fp in ghost frame for output
* PARAM 1
...
259:     ST  3,-10(1)	Save left side 
260:     LD  3,-8(1)	Load variable dog
261:     LD  4,-10(1)	Load left into ac1 
262:    ADD  3,4,3	Op + 
...
* EXPRESSION
* CALL output
269:     ST  1,-9(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
281:     ST  1,-9(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL get
286:     ST  1,-10(1)	Store fp in ghost frame for get
* PARAM 1
287:    LDA  3,-1(0)	Load address of base of array y
288:     ST  3,-12(1)	Store parameter 
* PARAM 2
289:    LDC  3,2(6)	Load integer constant 
290:     ST  3,-13(1)	Store parameter 
* END PARAM get
291:    LDA  1,-10(1)	Load address of new frame 
...
* EXPRESSION
* CALL output
296:     ST  1,-9(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
303:     ST  1,-9(1)	Store fp in ghost frame for output
* PARAM 1
* CALL get
304:     ST  1,-11(1)	Store fp in ghost frame for get
* PARAM 1
...
* EXPRESSION
* CALL output
318:     ST  1,-9(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
330:     ST  1,-9(1)	Store fp in ghost frame for outnl
* END PARAM outnl
