...
* EXPRESSION
* CALL outnl
 62:     ST  1,-8(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
 ...
 68:     ST  3,-9(1)	Save left side 
 69:    LDC  3,1(6)	Load integer constant 
 70:     LD  4,-9(1)	Load left into ac1 
 71:    ADD  3,4,3	Op + 
 72:     ST  3,-3(1)	Store variable bilbo
* EXPRESSION
* CALL output
 73:     ST  1,-8(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
 80:     ST  1,-8(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
 ...
 92:     ST  3,-12(1)	Save left side 
 93:     LD  3,-6(1)	Load variable pippin
 94:     LD  4,-12(1)	Load left into ac1 
 95:    MUL  3,4,3	Op * 
 96:     LD  4,-11(1)	Load left into ac1 
 97:    ADD  3,4,3	Op + 
 98:     LD  4,-10(1)	Load left into ac1 
 99:    MUL  3,4,3	Op * 
100:     LD  4,-9(1)	Load left into ac1 
101:    ADD  3,4,3	Op + 
102:     ST  3,-3(1)	Store variable bilbo
* EXPRESSION
* CALL output
103:     ST  1,-8(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
110:     ST  1,-8(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
116:     ST  3,-9(1)	Save left side 
117:     LD  3,-6(1)	Load variable pippin
118:     LD  4,-9(1)	Load left into ac1 
119:    MUL  3,4,3	Op * 
120:     ST  3,-9(1)	Save left side 
121:     LD  3,-4(1)	Load variable sam
122:     LD  4,-9(1)	Load left into ac1 
123:    ADD  3,4,3	Op + 
124:     ST  3,-9(1)	Save left side 
125:     LD  3,-3(1)	Load variable bilbo
126:     LD  4,-9(1)	Load left into ac1 
127:    MUL  3,4,3	Op * 
128:     ST  3,-9(1)	Save left side 
129:     LD  3,-2(1)	Load variable frodo
130:     LD  4,-9(1)	Load left into ac1 
131:    ADD  3,4,3	Op + 
132:     ST  3,-3(1)	Store variable bilbo
* EXPRESSION
* CALL output
133:     ST  1,-8(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
140:     ST  1,-8(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
154:     ST  3,-13(1)	Save left side 
155:     LD  3,-3(1)	Load variable bilbo
156:     LD  4,-13(1)	Load left into ac1 
157:    ADD  3,4,3	Op + 
...
163:    SUB  3,4,3	Op - 
164:     LD  4,-9(1)	Load left into ac1 
165:    ADD  3,4,3	Op + 
166:     ST  3,-3(1)	Store variable bilbo
* EXPRESSION
* CALL output
167:     ST  1,-8(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
174:     ST  1,-8(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL outnl
226:     ST  1,-8(1)	Store fp in ghost frame for outnl
* END PARAM outnl
