...
* PARAM 1
* CALL ident
 54:     ST  1,-5(1)	Store fp in ghost frame for ident
* PARAM 1
...
* PARAM 1
* CALL ident
 67:     ST  1,-5(1)	Store fp in ghost frame for ident
* PARAM 1
...
* CALL ident
 86:     ST  1,-6(1)	Store fp in ghost frame for ident
* PARAM 1
...
* PARAM 1
* CALL ident
106:     ST  1,-5(1)	Store fp in ghost frame for ident
* PARAM 1
...
* PARAM 1
* CALL ident
127:     ST  1,-5(1)	Store fp in ghost frame for ident
* PARAM 1
...
* PARAM 1
* CALL ident
153:     ST  1,-5(1)	Store fp in ghost frame for ident
* PARAM 1
...
* EXPRESSION
* CALL output
171:     ST  1,-3(1)	Store fp in ghost frame for output
* PARAM 1
* CALL ident
172:     ST  1,-5(1)	Store fp in ghost frame for ident
* PARAM 1
...
* EXPRESSION
* CALL outnl
192:     ST  1,-3(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* PARAM 1
* CALL ident
198:     ST  1,-5(1)	Store fp in ghost frame for ident
* PARAM 1
...
* PARAM 1
* CALL ident
223:     ST  1,-5(1)	Store fp in ghost frame for ident
* PARAM 1
...
* EXPRESSION
* CALL output
251:     ST  1,-3(1)	Store fp in ghost frame for output
* PARAM 1
* CALL ident
252:     ST  1,-5(1)	Store fp in ghost frame for ident
* PARAM 1
...
* EXPRESSION
* CALL outnl
286:     ST  1,-3(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL outputb
291:     ST  1,-3(1)	Store fp in ghost frame for outputb
* PARAM 1
* CALL ident
292:     ST  1,-5(1)	Store fp in ghost frame for ident
* PARAM 1
...
* EXPRESSION
* CALL outputb
334:     ST  1,-3(1)	Store fp in ghost frame for outputb
* PARAM 1
* CALL ident
335:     ST  1,-5(1)	Store fp in ghost frame for ident
* PARAM 1
...
* EXPRESSION
* CALL outnl
377:     ST  1,-3(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL outputb
382:     ST  1,-3(1)	Store fp in ghost frame for outputb
* PARAM 1
* CALL ident
383:     ST  1,-5(1)	Store fp in ghost frame for ident
* PARAM 1
...
* EXPRESSION
* CALL outputb
427:     ST  1,-3(1)	Store fp in ghost frame for outputb
* PARAM 1
* CALL ident
428:     ST  1,-5(1)	Store fp in ghost frame for ident
* PARAM 1
...
* EXPRESSION
* CALL outnl
474:     ST  1,-3(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL outputb
479:     ST  1,-3(1)	Store fp in ghost frame for outputb
* PARAM 1
* CALL ident
480:     ST  1,-5(1)	Store fp in ghost frame for ident
* PARAM 1
...
* EXPRESSION
* CALL outputb
534:     ST  1,-3(1)	Store fp in ghost frame for outputb
* PARAM 1
* CALL ident
535:     ST  1,-5(1)	Store fp in ghost frame for ident
* PARAM 1
...
* EXPRESSION
* CALL outnl
597:     ST  1,-3(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL outputb
602:     ST  1,-3(1)	Store fp in ghost frame for outputb
* PARAM 1
* CALL ident
603:     ST  1,-6(1)	Store fp in ghost frame for ident
* PARAM 1
604:    LDC  3,111(6)	Load integer constant 
605:     ST  3,-8(1)	Store parameter 
* END PARAM ident
606:    LDA  1,-6(1)	Load address of new frame 
607:    LDA  3,1(7)	Return address in ac 
608:    LDA  7,-567(7)	CALL ident
609:    LDA  3,0(2)	Save the result in ac 
* END CALL ident
610:     ST  3,-6(1)	Save left side 
611:    LDC  3,222(6)	Load integer constant 
612:     LD  4,-6(1)	Load left into ac1 
613:    ADD  3,4,3	Op + 
614:    LDC  4,0(6)	Load 0 
615:    SUB  3,4,3	Op unary - 
616:    LDC  4,0(6)	Load 0 
617:    SUB  3,4,3	Op unary - 
618:     ST  3,-6(1)	Save left side 
619:    LDC  3,333(6)	Load integer constant 
620:     LD  4,-6(1)	Load left into ac1 
621:    MUL  3,4,3	Op * 
622:     ST  3,-6(1)	Save left side 
623:    LDC  3,444(6)	Load integer constant 
624:     LD  4,-6(1)	Load left into ac1 
625:    DIV  3,4,3	Op / 
626:     ST  3,-6(1)	Save left side 
627:    LDC  3,42(6)	Load integer constant 
628:     LD  4,-6(1)	Load left into ac1 
629:    DIV  5,4,3	Op % 
630:    MUL  5,5,3	 
631:    SUB  3,4,5	 
632:     ST  3,-6(1)	Save left side 
633:    LDC  3,555(6)	Load integer constant 
634:     LD  4,-6(1)	Load left into ac1 
635:    ADD  3,4,3	Op + 
636:     ST  3,-6(1)	Save left side 
637:    LDC  3,666(6)	Load integer constant 
638:     LD  4,-6(1)	Load left into ac1 
639:    TLE  3,4,3	Op <= 
640:    LDC  4,1(6)	Load 1 
641:    XOR  3,3,4	Op NOT 
642:    LDC  4,1(6)	Load 1 
643:    XOR  3,3,4	Op NOT 
644:     ST  3,-6(1)	Save left side 
645:    LDC  3,777(6)	Load integer constant 
646:     ST  3,-7(1)	Save left side 
647:    LDC  3,888(6)	Load integer constant 
648:     LD  4,-7(1)	Load left into ac1 
649:    TLT  3,4,3	Op < 
650:     LD  4,-6(1)	Load left into ac1 
651:    AND  3,4,3	Op AND 
652:     ST  3,-6(1)	Save left side 
653:    LDC  3,999(6)	Load integer constant 
654:     ST  3,-7(1)	Save left side 
655:    LDC  3,1000(6)	Load integer constant 
656:     LD  4,-7(1)	Load left into ac1 
657:    TNE  3,4,3	Op != 
658:     LD  4,-6(1)	Load left into ac1 
659:     OR  3,4,3	Op OR 
...
* EXPRESSION
* CALL outnl
666:     ST  1,-3(1)	Store fp in ghost frame for outnl
* END PARAM outnl
