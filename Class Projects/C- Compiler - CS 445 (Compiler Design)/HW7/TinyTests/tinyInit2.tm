...
* COMPOUND
 ...
 48:     ST  3,-26(1)	Save left side 
 49:    LDC  3,888(6)	Load integer constant 
 50:     LD  4,-26(1)	Load left into ac1 
 51:    MUL  3,4,3	Op * 
 52:     LD  4,-25(1)	Load left into ac1 
 53:    ADD  3,4,3	Op + 
 54:     ST  3,-25(1)	Store variable y
* Compound Body
* EXPRESSION
* CALL output
 55:     ST  1,-26(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
 63:     ST  1,-26(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
 71:     ST  1,-26(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
 79:     ST  1,-26(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL output
 84:     ST  1,-26(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
 91:     ST  1,-26(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
 98:     ST  1,-26(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
105:     ST  1,-26(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
121:    LDC  3,33(6)	load size of array c
122:     ST  3,-13(0)	save size of array c
...
134:     ST  3,-26(1)	Save left side 
135:    LDC  3,777(6)	Load integer constant 
136:     ST  3,-27(1)	Save left side 
137:    LDC  3,666(6)	Load integer constant 
138:     LD  4,-27(1)	Load left into ac1 
139:    MUL  3,4,3	Op * 
140:     LD  4,-26(1)	Load left into ac1 
141:    ADD  3,4,3	Op + 
142:     ST  3,-47(0)	Store variable z
