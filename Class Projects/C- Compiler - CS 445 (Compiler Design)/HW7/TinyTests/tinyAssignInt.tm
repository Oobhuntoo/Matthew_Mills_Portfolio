...
* EXPRESSION
* CALL output
 47:     ST  1,-16(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
 61:     ST  1,-16(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
 ...
 84:    LDC  3,444(6)	Load integer constant 
...
* EXPRESSION
* CALL output
 89:     ST  1,-16(1)	Store fp in ghost frame for output
* PARAM 1
...
* END CALL outnl
* EXPRESSION
106:    LDC  3,555(6)	Load integer constant 
107:     ST  3,-2(1)	Store variable px
* EXPRESSION
* CALL output
108:     ST  1,-16(1)	Store fp in ghost frame for output
* PARAM 1
...
117:    LDC  3,666(6)	Load integer constant 
...
* END CALL output
* EXPRESSION
134:    LDC  3,777(6)	Load integer constant 
135:     ST  3,-12(0)	Store variable sx
* EXPRESSION
* CALL output
136:     ST  1,-16(1)	Store fp in ghost frame for output
* PARAM 1
...
145:    LDC  3,888(6)	Load integer constant 
...
* EXPRESSION
* CALL output
150:     ST  1,-16(1)	Store fp in ghost frame for output
* PARAM 1
