...
* File compiled:  tinyOverlapArray.c-
* 
* ** ** ** ** ** ** ** ** ** ** ** **
* FUNCTION input
...
* COMPOUND
 43:    LDC  3,2(6)	load size of array a
 44:     ST  3,-3(1)	save size of array a
* Compound Body
* COMPOUND
 45:    LDC  3,3(6)	load size of array b
 46:     ST  3,-6(1)	save size of array b
* Compound Body
* END COMPOUND
* COMPOUND
 47:    LDC  3,4(6)	load size of array c
 48:     ST  3,-6(1)	save size of array c
* Compound Body
* END COMPOUND
* COMPOUND
* Compound Body
* COMPOUND
 ...
 50:     ST  3,-6(1)	save size of array b
* Compound Body
* END COMPOUND
* COMPOUND
 51:    LDC  3,6(6)	load size of array c
 52:     ST  3,-6(1)	save size of array c
* Compound Body
* END COMPOUND
* END COMPOUND
* END COMPOUND
