...
* EXPRESSION
* CALL output
 72:     ST  1,-5(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
116:     ST  1,-5(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
123:     ST  1,-5(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
151:     ST  1,-5(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL output
162:     ST  1,-8(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
169:     ST  1,-8(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
176:     ST  1,-8(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
183:     ST  1,-8(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
190:     ST  1,-8(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
197:     ST  1,-8(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL output
212:     ST  1,-8(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
219:     ST  1,-8(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
226:     ST  1,-8(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
240:     ST  1,-8(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
247:     ST  1,-8(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL output
252:     ST  1,-8(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
259:     ST  1,-8(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
266:     ST  1,-8(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
273:     ST  1,-8(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
280:     ST  1,-8(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
287:     ST  1,-8(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL outnl
337:     ST  1,-8(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL output
342:     ST  1,-8(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
377:     ST  1,-8(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL agamemnon
382:     ST  1,-8(1)	Store fp in ghost frame for agamemnon
* END PARAM agamemnon
...
* EXPRESSION
* CALL output
387:     ST  1,-8(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
394:     ST  1,-8(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
401:     ST  1,-8(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
408:     ST  1,-8(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
415:     ST  1,-8(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
422:     ST  1,-8(1)	Store fp in ghost frame for outnl
* END PARAM outnl
