...
* EXPRESSION
* CALL outputc
 47:     ST  1,-16(1)	Store fp in ghost frame for outputc
* PARAM 1
...
* END PARAM outputc
 ...
 71:    LDA  7,-42(7)	CALL outputc
 72:    LDA  3,0(2)	Save the result in ac 
* END CALL outputc
* EXPRESSION
 73:    LDC  3,99(6)	Load char constant 
 74:     ST  3,-4(1)	Store variable x
* EXPRESSION
* CALL outputc
 75:     ST  1,-16(1)	Store fp in ghost frame for outputc
* PARAM 1
...
* EXPRESSION
 ...
 84:    LDC  3,100(6)	Load char constant 
...
* EXPRESSION
* CALL outputc
 89:     ST  1,-16(1)	Store fp in ghost frame for outputc
* PARAM 1
...
* END CALL outnl
* EXPRESSION
106:    LDC  3,101(6)	Load char constant 
107:     ST  3,-2(1)	Store variable px
* EXPRESSION
* CALL outputc
108:     ST  1,-16(1)	Store fp in ghost frame for outputc
* PARAM 1
...
* EXPRESSION
* CALL outputc
122:     ST  1,-16(1)	Store fp in ghost frame for outputc
* PARAM 1
...
132:    LDA  7,-103(7)	CALL outputc
133:    LDA  3,0(2)	Save the result in ac 
* END CALL outputc
* EXPRESSION
134:    LDC  3,102(6)	Load char constant 
135:     ST  3,-12(0)	Store variable sx
* EXPRESSION
* CALL outputc
136:     ST  1,-16(1)	Store fp in ghost frame for outputc
* PARAM 1
...
145:    LDC  3,104(6)	Load char constant 
...
* EXPRESSION
* CALL outputc
150:     ST  1,-16(1)	Store fp in ghost frame for outputc
* PARAM 1
