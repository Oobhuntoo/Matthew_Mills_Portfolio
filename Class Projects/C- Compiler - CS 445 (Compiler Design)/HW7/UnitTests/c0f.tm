...
* EXPRESSION
* CALL output
 52:     ST  1,-10(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
 64:     ST  1,-10(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL outnl
 98:     ST  1,-10(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL output
103:     ST  1,-10(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL outnl
115:     ST  1,-10(1)	Store fp in ghost frame for outnl
* END PARAM outnl
