...
* EXPRESSION
* CALL outnl
 87:     ST  1,-2(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL outputb
114:     ST  1,-2(1)	Store fp in ghost frame for outputb
* PARAM 1
...
* EXPRESSION
* CALL outputb
125:     ST  1,-2(1)	Store fp in ghost frame for outputb
* PARAM 1
...
* EXPRESSION
* CALL outnl
136:     ST  1,-2(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL outnl
159:     ST  1,-2(1)	Store fp in ghost frame for outnl
* END PARAM outnl
