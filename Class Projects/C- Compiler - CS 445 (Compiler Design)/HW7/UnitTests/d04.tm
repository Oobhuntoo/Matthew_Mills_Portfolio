...
* EXPRESSION
* CALL outputb
 64:     ST  1,-5(1)	Store fp in ghost frame for outputb
* PARAM 1
...
* EXPRESSION
* CALL outputb
 79:     ST  1,-5(1)	Store fp in ghost frame for outputb
* PARAM 1
...
* EXPRESSION
* CALL outputb
 98:     ST  1,-5(1)	Store fp in ghost frame for outputb
* PARAM 1
...
* EXPRESSION
* CALL outputb
115:     ST  1,-5(1)	Store fp in ghost frame for outputb
* PARAM 1
...
* EXPRESSION
* CALL outputb
143:     ST  1,-5(1)	Store fp in ghost frame for outputb
* PARAM 1
...
* EXPRESSION
* CALL outputb
158:     ST  1,-5(1)	Store fp in ghost frame for outputb
* PARAM 1
...
* EXPRESSION
* CALL outputb
173:     ST  1,-5(1)	Store fp in ghost frame for outputb
* PARAM 1
...
* EXPRESSION
* CALL outputb
192:     ST  1,-5(1)	Store fp in ghost frame for outputb
* PARAM 1
...
* EXPRESSION
* CALL outnl
226:     ST  1,-5(1)	Store fp in ghost frame for outnl
* END PARAM outnl
