...
* EXPRESSION
* CALL output
 47:     ST  1,-3(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
165:     ST  1,-3(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
173:     ST  1,-3(1)	Store fp in ghost frame for output
* PARAM 1
...
* END IF
* IF
180:    LDC  3,1(6)	Load Boolean constant 
* THEN
* IF
...
* END IF
* IF
201:    LDC  3,1(6)	Load Boolean constant 
* THEN
* IF
...
* EXPRESSION
* CALL output
217:     ST  1,-3(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
232:     ST  1,-3(1)	Store fp in ghost frame for output
* PARAM 1
