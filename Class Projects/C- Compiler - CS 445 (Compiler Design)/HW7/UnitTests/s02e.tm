...
* EXPRESSION
* CALL load
 91:     ST  1,-2(1)	Store fp in ghost frame for load
* END PARAM load
...
* EXPRESSION
* CALL sum
 96:     ST  1,-2(1)	Store fp in ghost frame for sum
* PARAM 1
...
* EXPRESSION
* CALL sum
105:     ST  1,-2(1)	Store fp in ghost frame for sum
* PARAM 1
...
* PARAM 1
* CALL sum
115:     ST  1,-4(1)	Store fp in ghost frame for sum
* PARAM 1
...
* EXPRESSION
* CALL sum
129:     ST  1,-2(1)	Store fp in ghost frame for sum
* PARAM 1
...
* PARAM 1
* CALL sum
139:     ST  1,-4(1)	Store fp in ghost frame for sum
* PARAM 1
...
* EXPRESSION
* CALL outnl
153:     ST  1,-2(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
168:     ST  3,-2(0)	Store variable goad
