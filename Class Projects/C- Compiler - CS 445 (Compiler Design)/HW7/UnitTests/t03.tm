...
* RETURN
* CALL fib
 55:     ST  1,-3(1)	Store fp in ghost frame for fib
* PARAM 1
...
* CALL fib
 67:     ST  1,-4(1)	Store fp in ghost frame for fib
* PARAM 1
...
* EXPRESSION
* CALL fib
 89:     ST  1,-4(1)	Store fp in ghost frame for fib
* PARAM 1
...
* EXPRESSION
* CALL outnl
104:     ST  1,-3(1)	Store fp in ghost frame for outnl
* END PARAM outnl
