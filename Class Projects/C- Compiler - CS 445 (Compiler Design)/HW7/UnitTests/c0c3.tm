...
* EXPRESSION
* CALL outputc
 47:     ST  1,-2(1)	Store fp in ghost frame for outputc
* PARAM 1
...
* EXPRESSION
* CALL outputc
 54:     ST  1,-2(1)	Store fp in ghost frame for outputc
* PARAM 1
...
* EXPRESSION
* CALL outputc
 61:     ST  1,-2(1)	Store fp in ghost frame for outputc
* PARAM 1
...
* EXPRESSION
* CALL outputc
 70:     ST  1,-2(1)	Store fp in ghost frame for outputc
* PARAM 1
...
* EXPRESSION
* CALL outputc
 77:     ST  1,-2(1)	Store fp in ghost frame for outputc
* PARAM 1
...
* EXPRESSION
* CALL outputc
 84:     ST  1,-2(1)	Store fp in ghost frame for outputc
* PARAM 1
...
* EXPRESSION
* CALL outnl
 91:     ST  1,-2(1)	Store fp in ghost frame for outnl
* END PARAM outnl
