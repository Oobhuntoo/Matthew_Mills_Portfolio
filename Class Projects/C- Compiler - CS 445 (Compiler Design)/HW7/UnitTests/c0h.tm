...
* EXPRESSION
* CALL outnl
 72:     ST  1,-3(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL outnl
106:     ST  1,-3(1)	Store fp in ghost frame for outnl
* END PARAM outnl
...
* EXPRESSION
* CALL dog
125:     ST  1,-10(1)	Store fp in ghost frame for dog
* PARAM 1
...
* EXPRESSION
* CALL output
132:     ST  1,-10(1)	Store fp in ghost frame for output
* PARAM 1
