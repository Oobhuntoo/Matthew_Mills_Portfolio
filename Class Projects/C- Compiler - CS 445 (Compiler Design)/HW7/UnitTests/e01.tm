...
* EXPRESSION
* CALL output
 45:     ST  1,-3(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
145:     ST  1,-3(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
164:     ST  1,-3(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
172:     ST  1,-3(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
185:     ST  1,-3(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
193:     ST  1,-3(1)	Store fp in ghost frame for output
* PARAM 1
