...
* EXPRESSION
* CALL output
 47:     ST  1,-61(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
 55:     ST  1,-61(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
 63:     ST  1,-61(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
 71:     ST  1,-61(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
 79:     ST  1,-61(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
 89:     ST  1,-72(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
 97:     ST  1,-72(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
105:     ST  1,-72(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
113:     ST  1,-72(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
121:     ST  1,-72(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL output
134:     ST  1,-2(1)	Store fp in ghost frame for output
* PARAM 1
...
* EXPRESSION
* CALL cat
147:     ST  1,-2(1)	Store fp in ghost frame for cat
* END PARAM cat
...
* EXPRESSION
* CALL dog
152:     ST  1,-2(1)	Store fp in ghost frame for dog
* END PARAM dog
...
164:    LDC  3,23(6)	load size of array bs
165:     ST  3,-14(0)	save size of array bs
166:    LDC  3,34(6)	load size of array ds
167:     ST  3,-39(0)	save size of array ds
168:    LDC  3,45(6)	load size of array ds
169:     ST  3,-75(0)	save size of array ds
