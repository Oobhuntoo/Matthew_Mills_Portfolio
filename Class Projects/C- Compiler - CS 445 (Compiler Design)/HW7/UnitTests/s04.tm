...
* EXPRESSION
* CALL dog
 87:     ST  1,-2(1)	Store fp in ghost frame for dog
* PARAM 1
...
* EXPRESSION
* CALL cat
 94:     ST  1,-2(1)	Store fp in ghost frame for cat
* PARAM 1
...
* EXPRESSION
* CALL dog
101:     ST  1,-2(1)	Store fp in ghost frame for dog
* PARAM 1
...
* EXPRESSION
* CALL cat
108:     ST  1,-2(1)	Store fp in ghost frame for cat
* PARAM 1
...
* EXPRESSION
* CALL output
115:     ST  1,-2(1)	Store fp in ghost frame for output
* PARAM 1
