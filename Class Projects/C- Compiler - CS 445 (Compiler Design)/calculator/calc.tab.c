...
{
  "$end", "error", "$undefined", "NUMBER", "ID", "QUIT", "'\\n'", "'='",
  "'+'", "'-'", "'*'", "'/'", "'('", "')'", "$accept", "statementlist",
  "statement", "expression", "term", "varornum", YY_NULLPTR
};
#endif
...
{
       0,   256,   257,   258,   259,   260,    10,    61,    43,    45,
      42,    47,    40,    41
};
# endif
...
{
       0,    13,    14,     6,     0,     0,     0,     0,     5,     9,
      12,     0,    14,    16,     0,     1,     2,     0,     0,     0,
       0,     4,    15,     3,     7,     8,    10,    11
};
...
{
      13,     1,     2,     3,    11,     1,    12,     4,    17,    18,
       5,     4,    15,    22,     5,    26,    27,    17,    18,    16,
      19,    20,    24,    25,    23,    21,    14
};

static const yytype_uint8 yycheck[] =
{
       4,     3,     4,     5,     7,     3,     4,     9,     8,     9,
      12,     9,     0,    13,    12,    19,    20,     8,     9,     6,
      10,    11,    17,    18,    16,    11,     5
};
...
{
       0,     3,     4,     5,     9,    12,    15,    16,    17,    18,
      19,     7,     4,    19,    17,     0,     6,     8,     9,    10,
      11,    16,    13,    15,    18,    18,    19,    19
};
...
#line 34 "calc.y" /* yacc.c:1646  */
    { vars[(yyvsp[-2].tokenData)->idValue] = (yyvsp[0].value); (yyval.value)=(yyvsp[0].value); }
...
#line 55 "calc.y" /* yacc.c:1646  */
    { (yyval.value) = (yyvsp[0].tokenData)->numValue; }
#line 1293 "calc.tab.c" /* yacc.c:1646  */
    break;

  case 14:
#line 56 "calc.y" /* yacc.c:1646  */
    { (yyval.value) = vars[(yyvsp[0].tokenData)->idValue]; }
